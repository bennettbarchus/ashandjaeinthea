...
export default function Home() {
  ...
  return (
    <main className="min-h-screen w-full overflow-x-hidden bg-[#F8F5F0] text-[#5E3E2B]">
      ...
      >
        <div className="rounded-full border border-[#F8F5F0]/35 bg-[#5E3E2B]/24 px-5 py-3 text-center text-[#F8F5F0] shadow-[0_18px_46px_rgba(94,62,43,0.24)] backdrop-blur-md">
